  ...
  <div id="container">
    ...
    <div id="mpart">
      ...
      <div id="plant_details">
        <h1> Schefflera (Rs.300) </h1>
        <p>Schefflera is a popular houseplant,also known as dwarf umbrella tree. Its oval leaves that drop gracefully from a central stalkneeds bright but indirect light.</p>
        <p>
...
<?php
    ...
    $sql2="SELECT Plant_Id,Plant_Name,Plant_Price FROM Plants_Info WHERE Plant_Name='Schefflera'";
