  ...
  <div id="container">
    ...
    <div id="mpart">
      ...
      <div id="plant_details">
        <h1> Peepal Tree (Rs.454)</h1>
        <p>The peepal tree, Ficus religiosa, also known as the "bodhi" tree, is a deciduous tree that is native to India. This tree is sacred to those of the Buddhist faith, as it is believed to be the personification of Buddha. Cuttings from this tree exist in Sri Lanka that date back to 288 B.C.</p>
        <p>
...
<?php
    ...
    $sql2="SELECT Plant_Id,Plant_Name,Plant_Price FROM Plants_Info WHERE Plant_Name='Peepal Tree'";
