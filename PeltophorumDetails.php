  ...
  <div id="container">
    ...
    <div id="mpart">
      ...
      <div id="plant_details">
        <h1>Peltophorum Bloom (Rs.213)</h1>
          <p>
            Peltophorum pterocarpum (commonly known as copperpod, yellow-flamboyant, yellow flametree, yellow poinciana or yellow-flame)[2] is a species of Peltophorum, native to tropical southeastern Asia and a popular ornamental tree grown around the world. The tree is widely grown in tropical regions as an ornamental tree, particularly in India, Nigeria, Pakistan, and Florida and Hawaii in the United States.
          </p>
          <p>
             Used as decorating flower in Telangana State's Batukamma festival.The trees have been planted alternately in India as a common scheme for avenue trees in India alternately with Delonix regia (Poinciana) to give a striking yellow and red effect in summer, as has been done on Hughes road in Mumba
          </p>
      </div><br>
...
<?php
    ...
    $sql2="SELECT Plant_Id,Plant_Name,Plant_Price FROM Plants_Info WHERE Plant_Name='Peltophorum Bloom'";
