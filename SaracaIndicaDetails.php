    ...
    <div id="mpart">
      ...
      <div id="plant_details">
         <h1>Saraca Indica (Rs.342)</h1>
          ...
          <p>
              It is sometimes incorrectly known as Saraca indica. Plant belonging to the Caesalpinioideae subfamily of the legume family. ...
...
<?php
    ...
    $sql2="SELECT Plant_Id,Plant_Name,Plant_Price FROM Plants_Info WHERE Plant_Name='Saraca Indica'";
