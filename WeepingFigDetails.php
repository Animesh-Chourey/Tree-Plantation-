  ...
  <div id="container">
    ...
    <div id="mpart">
      ...
      <div id="plant_details">
        <h1>Weeping Fig (Rs.543)</h1>
          <p>
            Ficus benjamina, commonly known as weeping fig, benjamin fig[2] or ficus tree, and often sold in stores as just ficus, is a species of flowering plant in the family Moraceae, native to Asia and Australia.[3] It is the official tree of Bangkok.
          </p>
          <p>
...
<?php
    ...
    $sql2="SELECT Plant_Id,Plant_Name,Plant_Price FROM Plants_Info WHERE Plant_Name='Weeping Fig'";
